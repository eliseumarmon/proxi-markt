...
ProxiMarkt es una aplicación donde podremos vender y comprar productos como frutas y verduras.
...
Hemos optado por gastar una paleta de colores sencilla y de tonalidades verdes para darle un toque natural y minimalista a la aplicación.

---

### Logos

Al pensar en la creación del logo de la aplicación pensamos en algo minimalista y sencillo.

- El color de fonde es: #4ca626.
...
Este sería nuestro logo pequeño.

![Logo grande](img/logo_gr.png)

Y este sería nuestro logo en grande.
...
![Mis ventas](img/mis_compras.png)
...
![Valoraciones](img/mis_compras.png)
